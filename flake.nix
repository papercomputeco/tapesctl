          ...
          tapesctl = rustPlatform.buildRustPackage {
            ...
            cargoLock = {
              ...
              outputHashes = {
                ...
                # without a recompute.
                "tapes-harnesses-0.1.0" = "sha256-IT0MKPwfqY3OKUqvLOD5Zarsepv15fOP2Ff3bk4AVfA=";
                "tapes-cassette-client-0.1.0" = "sha256-IT0MKPwfqY3OKUqvLOD5Zarsepv15fOP2Ff3bk4AVfA=";
              };
            };
