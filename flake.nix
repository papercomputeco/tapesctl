          ...
          tapesctl = rustPlatform.buildRustPackage {
            ...
            cargoLock = {
              ...
              outputHashes = {
                ...
                # without a recompute.
                "tapes-harnesses-0.1.0" = "sha256-EOHpKNlywYZ/4IBfjMgbJz/2EBA8FC02gW54pPrfCv0=";
                "tapes-cassette-client-0.1.0" = "sha256-EOHpKNlywYZ/4IBfjMgbJz/2EBA8FC02gW54pPrfCv0=";
              };
            };
