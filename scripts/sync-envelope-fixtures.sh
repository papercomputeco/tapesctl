...
# envelope fixture corpus under crates/tapes-harness/vendor/tapes-envelope-fixtures/.
#
...
VENDOR_DIR="$REPO_ROOT/crates/tapes-harness/vendor/tapes-envelope-fixtures"
